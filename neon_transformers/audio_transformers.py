...
from ovos_plugin_manager.utils.streams import ReadWriteStream
from ovos_utils.configuration import read_mycroft_config
from ovos_utils.messagebus import get_mycroft_bus


def find_audio_transformer_plugins():
    return find_plugins(PluginTypes.AUDIO_TRANSFORM)
...
def load_audio_transformer_plugin(module_name):
    ...
    """
    return load_plugin(module_name, PluginTypes.AUDIO_TRANSFORM)
